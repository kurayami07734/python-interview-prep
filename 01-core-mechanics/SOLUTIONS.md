# Core Mechanics - Solutions

## Puzzle 1: Mutable Default Arguments (`puzzle_01_mutable_defaults.py`)
...
## Puzzle 2: Closure & Late Binding (`puzzle_02_closure_late_binding.py`)
...
## Puzzle 3: LEGB Scope (`puzzle_03_leb_scope.py`)
