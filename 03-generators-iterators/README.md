...
This module explores Python's generator and iterator protocols.

## Puzzles

### 1. Yield Basics (`puzzle_01_yield_basics.py`)

**Question:** How does generator execution work?
...
### 2. Yield From (`puzzle_02_yield_from.py`)
...
### 3. Custom Iterators (`puzzle_03_custom_iterators.py`)

**Question:** What methods are needed for a custom iterator?
