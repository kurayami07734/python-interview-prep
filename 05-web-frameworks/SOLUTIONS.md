# Web Frameworks - Solutions

## Puzzle 1: Flask Request Context (`puzzle_01_flask_context.py`)
...
## Puzzle 2: FastAPI Dependency Injection (`puzzle_02_fastapi_di.py`)
...
## Puzzle 3: Pydantic Validation (`puzzle_03_pydantic_validation.py`)
