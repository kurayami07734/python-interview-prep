...
## Challenge 1: Retry Decorator (`challenge_01_retry_decorator.py`)
...
## Challenge 2: Simple Router (`challenge_02_simple_router.py`)
...
## Challenge 3: Custom Future (`challenge_03_custom_future.py`)
