...
This module explores Python's object-oriented programming internals.

## Puzzles

### 1. MRO - Diamond Inheritance (`puzzle_01_mro_diamond.py`)

**Question:** Which method gets called in diamond inheritance?
...
### 2. Class vs Instance Variables (`puzzle_02_class_vs_instance.py`)

**Question:** What happens when you modify a class variable from an instance?
...
### 3. `__new__` vs `__init__` (`puzzle_03_new_vs_init.py`)

**Question:** When does each method run in object creation?
